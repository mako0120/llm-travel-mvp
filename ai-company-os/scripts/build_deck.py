...
PALETTE_PRESETS = {
    ...
    # 2026-08-04〜追加。シミュレーション・デジタルツイン系テーマ向け
    # (深紫の「仮想空間」+シアンの「シミュレーション・グリッド発光」)。
    # 既存5プリセット(navy_gold/forest_sand/slate_azure/steel_amber/impact_red)
    # とは重複しない配色として、Antioch(ロボティクスシミュレーション基盤)テーマで新規追加。
    "indigo_cyan": {
        "primary": "2E2A72",
        "primary_dark": "1B1846",
        "base": "D6D9F5",
